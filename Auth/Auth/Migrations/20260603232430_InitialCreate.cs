    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "View products", "products.view" },
                    { 2, "Create products", "products.create" },
                    { 3, "Edit products", "products.edit" },
                    { 4, "Delete products", "products.delete" },
                    { 5, "Manage users", "users.manage" },
                    { 6, "View orders", "orders.view" },
                    { 7, "Manage orders", "orders.manage" }
                });
